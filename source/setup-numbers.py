...
img =  Image.open(ds_asl_dir+"\\0\\hand1_0_bot_seg_1_cropped.jpeg")
...
data_augmentation = ImageDataGenerator(rotation_range=20, rescale=1/255, zoom_range=0.2, horizontal_flip=True,
...
model_dl.add(Conv2D(16,(3,3),activation="relu",padding="same",input_shape=(input_shape)))
...
#model_dl.add(Conv2D(64,(3,3),activation="relu"))#Added 25/2/2021 13:14
model_dl.add(MaxPool2D(2,2))
#model_dl.add(Dropout(0.2))
model_dl.add(Conv2D(128,(3,3),activation="relu"))
model_dl.add(Conv2D(128,(3,3),activation="relu"))
model_dl.add(MaxPool2D(2,2))
model_dl.add(Conv2D(256,(3,3),activation="relu"))
model_dl.add(Conv2D(256,(3,3),activation="relu"))
#model_dl.add(MaxPool2D(2,2)) #Added 25/2/2021 13:14
#model_dl.add(Conv2D(256,(3,3),activation="relu"))#Added 25/2/2021 13:14
#model_dl.add(Conv2D(256,(3,3),activation="relu"))#Added 25/2/2021 13:14
#model_dl.add(Dropout(0.2))
model_dl.add(Flatten())
model_dl.add(Dense(128,activation="relu"))
...
#model_dl.add(Dropout(0.4))
model_dl.add(Dropout(0.2))
model_dl.add(Dense(256,activation="relu"))#Added 25/2/2021 13:14
model_dl.add(Dropout(0.2))#Added 25/2/2021 13:14
model_dl.add(Dense(128,activation="relu"))#Added 25/2/2021 13:14
model_dl.add(Dropout(0.2))'''#Added 25/2/2021 13:14
#model_dl.add(Dense(len(folder_list),activation="softmax"))
